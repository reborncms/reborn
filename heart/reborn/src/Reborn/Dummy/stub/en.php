...
return array(
        ...
        'table' => array(
                'header' => array('Title', 'Category', 'Author', 'Created At'),
                'body' => array(
                        array(
                                'My First Post', 'International Sport', 'Thet Paing', '29-08-2013'
                            ),
                        array(
                                'Second Post Title', 'News', 'Khay', '25-08-2013'
                            ),
                        array(
                                'This is my third post', 'Local News', 'Hein Zaw Htet', '24-08-2013'
                            ),
                        array(
                                'Hello World for post number four', 'Blog', 'Yan Naing', '11-08-2013'
                            )
                        )
            ),
