...
',
		...
		'multi_comment' 	=> 'မှတ်ချက် %s ခုရှိသည်။',
	),
	'multi' 				=> array(
	...
	'label'					=> array(
		...
		'message'			=> 'အကြောင်းအရာ',
		'status'			=> 'အခြေအနေ',
		'edit_info'			=> '%s မှ နောက်ဆုံးပြုပြင်ထားသည်။',
		...
		'reply_to'			=> '%s ၏ မှတ်ချက်အား ပြန်ဖြေကြားမည်။',
		'edit_comment'		=> '%s ၏ မှတ်ချက်အား ပြင်ဆင် မည်။',
		'post_comment_as'	=> '%s အဖြစ် မှတ်ချက်တင်မည်။',
		'logout'			=> 'Logout',
	),
);
